...
entry_3 = Entry(root,textvar=Address)
entry_3.place(x=280,y=230)

label_4 = Label(root, text="Status",width=20,font=("bold", 10))
label_4.place(x=80,y=280)

entry_3 = Entry(root,textvar=status1)
entry_3.place(x=280,y=280)

label_5 = Label(root, text="Mobile No",width=20,font=("bold", 10))
label_5.place(x=85,y=330)

entry_5 = Entry(root,textvar=Mobile)
entry_5.place(x=280,y=330)

Button(root, text='Submit',width=20,bg='brown',fg='white',command=database).place(x=80,y=380)

Button(root, text='Display',width=20,bg='brown',fg='white',command=display).place(x=280,y=380)
